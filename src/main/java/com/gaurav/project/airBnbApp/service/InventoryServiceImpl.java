...
import com.gaurav.project.airBnbApp.dto.*;
import com.gaurav.project.airBnbApp.entity.*;
import com.gaurav.project.airBnbApp.exception.ResourceNotFoundException;
import com.gaurav.project.airBnbApp.repository.HotelMinPriceRepository;
import com.gaurav.project.airBnbApp.repository.InventoryRepository;
...
public class InventoryServiceImpl implements InventoryService{
    ...
    public List<InventoryDto> getAllInventoryByRoom(Long roomId) {
        ...
        if(!user.equals(room.getHotel().getOwner())) throw new AccessDeniedException("you are not a owner of room with ID: "+roomId);

        return inventoryRepository.findByRoomOrderByDate(room).stream()
                .map((elment)-> modelMapper.map(elment, InventoryDto.class))
    ...
    public void updateInventory(Long roomId, UpdateInventoryRequestDto updateInventoryRequestDto) {
        log.info("Update All inventory by room for room with id: {} between date range {} - {}", roomId,
